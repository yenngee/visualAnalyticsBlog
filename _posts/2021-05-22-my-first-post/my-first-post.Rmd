...
title: "My first post"
description: |
  Learning how to do R Markdown following lecture from prof.
author:
  - name: Ng Yen Ngee
...
In this article, we will show you how to plot a figure with multiple histograms by using [**`ggplot2`**](https://ggplot2.tidyverse.org/index.html) and [**`ggpubr`**](https://www.rdocumentation.org/packages/ggpubr/versions/0.4.0) packages. 
...
![](img/salesAndProfit_inClassEx2.jpg)
