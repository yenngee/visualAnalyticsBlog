...
```{r}
knitr::include_graphics("img/step-B3_filter.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-B5_after_pivot.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-B6_calculated_field.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-B6_calculated_field2.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-B7_final.jpg")
```

In the work space, we can also see the following work flow: 

```{r} 
knitr::include_graphics("img/step-B7_final_flow.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C1_drag_and_drop.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C2_filter_country.jpg")
```

Results will look like this:

```{r} 
knitr::include_graphics("img/step-C2_filter_country_after.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C3_trade_type.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C4_area_chart.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C5_change_to_quarter.jpg")
```

This is the result: 

```{r} 
knitr::include_graphics("img/step-C5_result.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C6_sort.jpg")
```

This is the result: 

```{r} 
knitr::include_graphics("img/step-C6_result.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C7_yaxis.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C8_xaxis_format.jpg")
```

Let us also change all the font size under `Default` and `Title` to size 8, `Tableau Book`.  

```{r} 
knitr::include_graphics("img/step-C8_xaxis_font.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C8_xaxis_tick.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C9_add_circles.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C10_results.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C11_annotate.jpg")
```
...
```{r} 
knitr::include_graphics("img/step-C11_ref_band.jpg")
```
